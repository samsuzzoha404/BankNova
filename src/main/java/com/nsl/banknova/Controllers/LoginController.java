package com.nsl.banknova.Controllers;

import com.nsl.banknova.Models.Model;
import com.nsl.banknova.Views.AccountType;
...
public class LoginController implements Initializable {
    ...
    private void onLogin() {
        ...
        if (Model.getInstance().getViewFactory().getLoginAccountType() == AccountType.CLIENT) {
            // Evaluate the client login credentials
            ...
            // Evaluate the admin login credentials
    ...
    private void setAcc_selector() {
        ...
        // Change the label text based on the selected account type
