package com.nsl.banknova.Models;
...
public class DatabaseDriver {
    ...
    public DatabaseDriver() {
        try {
            this.conn = DriverManager.getConnection("jdbc:sqlite:banknova.db");
    ...
    * */
    ...
    // Savings Account Balance Returning Method
    ...
    // Method to either add or subtract balance from given operation
    ...
    // Create transaction record method
